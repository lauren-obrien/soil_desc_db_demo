---
title: "New Zealand Soil Description Manual 2024 - Demonstration database - SQLite"
...
A naming convention is applied to the tables to clearly distingish data-storing tables ('dat\_\*') from support tables containing code lists ('cod\_\*') as SQLite doesn't offer full schema support.
...
CREATE TABLE IF NOT EXISTS dat_surface_cover (
  ...
  amt_surface_cover_p REAL CHECK (amt_surface_cover_p BETWEEN 0 AND 100),
...
CREATE TABLE IF NOT EXISTS dat_horizon_arch (
  ...
  amt_rock_frags_p REAL CHECK (amt_other_frags_p BETWEEN 0 and 100),
  amt_other_frags_p REAL CHECK (amt_rock_frags_p BETWEEN 0 and 100),

...
A naming convention is applied to the tables to clearly distingish data-storing tables ('dat_\*') from controlled code lists ('cod_\*') as SQLite doesn't offer full schemas.

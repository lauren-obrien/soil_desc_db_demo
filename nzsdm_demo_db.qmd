...
/* Table 17.2 */
INSERT INTO sensitivities VALUES
...
CREATE TABLE IF NOT EXISTS plasticities (
...
/* Table 17.3 */
INSERT INTO plasticities VALUES
...
CREATE TABLE IF NOT EXISTS stickinesses (
...
/* Table 17.4 */
INSERT INTO stickinesses VALUES
...
CREATE TABLE IF NOT EXISTS penrests (
...
CREATE TABLE IF NOT EXISTS fluidities (
...
CREATE TABLE IF NOT EXISTS indurations (
...
/* Table 17.9 */
INSERT INTO indurations VALUES   
...
CREATE TABLE IF NOT EXISTS consistence_tests (
  id_site VARCHAR,
  id_horizon INTEGER,
  FOREIGN KEY (id_site, id_horizon) REFERENCES horizon(id_site, id_horizon),
  PRIMARY KEY (id_site, id_horizon),
  ind_cohesive BOOLEAN,
  cato_strength_unconfined VARCHAR REFERENCES strengths(cato_strength),
  cato_strength_ped VARCHAR REFERENCES strengths(cato_strength),
  cato_strength_remoulded VARCHAR REFERENCES strengths(cato_strength),
  cato_strength_plastic VARCHAR REFERENCES strengths(cato_strength),
  cato_strength_sensitivity VARCHAR REFERENCES sensitivities(cato_sensitivity),
  cato_strength_plasticity VARCHAR REFERENCES plasticities(cato_plasticity),
  cato_strength_stickiness VARCHAR REFERENCES stickinesses(cato_stickiness),
  ind_dilatent BOOLEAN,
  cato_penetration_rest VARCHAR REFERENCES penrests(cato_penrest),
  cato_packing VARCHAR REFERENCES packings(cato_packing),
  catu_failure VARCHAR REFERENCES failures(catu_failure),
  cato_fluidity VARCHAR REFERENCES fluidities(catu_fluidity),
  cato_induration VARCHAR REFERENCES indurations(cato_induration)
  );
...
CREATE TABLE IF NOT EXISTS pH_raupachs (
  id_raupach INTEGER PRIMARY KEY,
  cato_raupach VARCHAR UNIQUE
  );

INSERT INTO pH_raupachs VALUES
  (1, '2.0'),
  (2, '2.5'),
  (3, '3.0'),
  (4, '3.5'),
...
CREATE TABLE IF NOT EXISTS h2o2_rxns (
...
CREATE TABLE IF NOT EXISTS hcl_rxns (
...
CREATE TABLE IF NOT EXISTS naf_rxns (
...
CREATE TABLE IF NOT EXISTS slaking_rxns (
...
/* Table 18.4 */
INSERT INTO slaking_rxns VALUES
...
CREATE TABLE IF NOT EXISTS dispersion_rxns (
...
/* Table 18.5 */
INSERT INTO dispersion_rxns VALUES  
...
CREATE TABLE IF NOT EXISTS field_tests (
  ...
  cato_pH_raupach VARCHAR REFERENCES pH_raupachs(cato_raupach),
  val_pH_water DECIMAL (6, 2) CHECK (val_pH_water BETWEEN 0 AND 14),
  val_pH_h2o2 DECIMAL (6, 2) CHECK (val_pH_h2o2 BETWEEN 0 AND 14),
  cato_h2o2_rxn VARCHAR REFERENCES h2o2_rxns(cato_h2o2_rxn),
  amt_ec_dSm DECIMAL (6, 2) CHECK (amt_ec_dSm <= 0),
  cato_hcl_rxn VARCHAR REFERENCES hcl_rxns(cato_hcl_rxn),
  ind_mn_rxn BOOLEAN,
  cato_naf_rxn VARCHAR REFERENCES naf_rxns(cato_naf_rxn),
  ind_22bip_rxn BOOLEAN,
  ind_water_repellent BOOLEAN,
  cato_slaking VARCHAR REFERENCES slaking_rxns(cato_slaking_rxn),
  cato_dispersion VARCHAR REFERENCES dispersion_rxns(cato_dispersion_rxn)
  );
...
CREATE TABLE IF NOT EXISTS horizon_names_primary (
...
/* Table 20.1 */
INSERT INTO horizon_names_primary VALUES
...
CREATE TABLE IF NOT EXISTS horizon_names_secondary (
...
/* Tables 20.2 - 20.7 */
INSERT INTO horizon_names_secondary VALUES
...
CREATE TABLE IF NOT EXISTS horizon_suffix_redox (
...
/* Table 20.8 */
INSERT INTO horizon_suffix_redox VALUES
...
CREATE TABLE IF NOT EXISTS horizon_suffix_other (
...
/* Table 20.9 */
INSERT INTO horizon_suffix_other VALUES
 ...
 CREATE TABLE IF NOT EXISTS horizon_names_functional (
...
INSERT INTO horizon_names_functional VALUES 
  (1, 'Lw', 'Loamy weak'),
  (2, 'SLw', 'Stony loamy, weak'),
  (3, 'VLc', 'Very stony loamy compact'),
  (4, 'XL', 'Extremely stony loamy');

CREATE TABLE IF NOT EXISTS horizon_permeabilities (
...
/* Table 20.17 */  
INSERT INTO horizon_permeabilities VALUES 
...
CREATE TABLE IF NOT EXISTS horizon_drainage_classes (
...
/* Table 21.5 */
INSERT INTO horizon_drainage_classes VALUES
  (1, 'VP', 'Very Poor'),
  (2, 'PO', 'Poor'),
  (3, 'IP', 'Imperfect'),
...
CREATE TABLE IF NOT EXISTS horizon_names (
  id_site VARCHAR,
  id_horizon INTEGER,
  FOREIGN KEY (id_site, id_horizon) REFERENCES horizon(id_site, id_horizon),
  PRIMARY KEY (id_site, id_horizon),
  /* conventional */
  catu_horizon_primary VARCHAR REFERENCES horizon_names_primary(catu_horizon_primary),
  catu_horizon_secondary VARCHAR REFERENCES horizon_names_secondary(catu_horizon_secondary),
  catu_horizon_suffix_redox VARCHAR REFERENCES horizon_suffix_redox(catu_horizon_suffix_redox),
  ...
  /* FH */
  catu_functional_name VARCHAR REFERENCES horizon_names_functional(catu_horizon_functional),
  cato_functional_perm VARCHAR REFERENCES horizon_permeabilities(cato_functional_perm),
  ind_topsoil BOOLEAN DEFAULT FALSE,
  ind_tephra_acid BOOLEAN DEFAULT FALSE,
  ind_tephra_basic BOOLEAN DEFAULT FALSE,
  cato_horizon_drainage VARCHAR REFERENCES horizon_drainage_classes(cato_horizon_drainage)
  );

CREATE TABLE IF NOT EXISTS horizon_names_suffix_other (
  id_site VARCHAR,
  id_horizon INTEGER,
  id_suffix INTEGER,
  FOREIGN KEY (id_site, id_horizon) REFERENCES horizon_names(id_site, id_horizon),
  PRIMARY KEY (id_site, id_horizon, id_suffix),
  catu_horizon_suffix VARCHAR REFERENCES horizon_suffix_other(catu_horizon_suffix_other)
  );
...
CREATE TABLE IF NOT EXISTS size_classes_solids (
...
/* Table 21.1 */
INSERT INTO size_classes_solids VALUES
   (1, '1', 'Microfine', '< 1 mm'),
...
CREATE TABLE IF NOT EXISTS size_classes_rocks (
...
/* Table 21.2 */
INSERT INTO size_classes_rocks VALUES
...
CREATE TABLE IF NOT EXISTS abundance_classes_roots (
...
/* Table 21.3 */
INSERT INTO abundance_classes_roots VALUES
  (1, '0',     'None',          '0%'),
  (2, '1',      'Few',   '> 0 - 5%'),
  (3, '2',   'Common',  '> 5 - 25%'),
  (4, '3',     'Many',  '> 25 - 50%'),
...
CREATE TABLE IF NOT EXISTS abundance_classes_solids (
...
/* Table 21.4 */
INSERT INTO abundance_classes_solids VALUES
 (1, '0',     'None',          '0%'),
 (2, '1', 'Very Few',    '> 0 - 2%'),
 (3, '2',      'Few',    '> 2 - 10'),
 (4, '3',   'Common',  '> 10 - 35%'),
...
CREATE TABLE IF NOT EXISTS nzsc_orders (
  catu_nzsc_order VARCHAR PRIMARY KEY,
  txt_nzsc_order_name VARCHAR
  );
  
INSERT INTO nzsc_orders VALUES
  ('O', 'Organic'),
  ('G', 'Gley'),
  ('U', 'Ultic'),
  ('Z', 'Podzol'),
...
CREATE TABLE IF NOT EXISTS nzsc_groups (
  catu_nzsc_order VARCHAR REFERENCES nzsc_orders(catu_nzsc_order),
  catu_nzsc_group VARCHAR,
  PRIMARY KEY (catu_nzsc_order, catu_nzsc_group),
  txt_nzsc_group_name VARCHAR 
  );

INSERT INTO nzsc_groups VALUES
  ('O', 'L', 'Litter'),
  ('O', 'M', 'Mesic'),
  ('O', 'F', 'Fibric'),
  ('O', 'H', 'Humic'),
...
CREATE TABLE IF NOT EXISTS nzsc_subgroups (
  catu_nzsc_order VARCHAR,
  catu_nzsc_group VARCHAR, 
  FOREIGN KEY (catu_nzsc_order, catu_nzsc_group) REFERENCES nzsc_groups(catu_nzsc_order, catu_nzsc_group),
  catu_nzsc_subgroup VARCHAR,
  PRIMARY KEY (catu_nzsc_order, catu_nzsc_group, catu_nzsc_subgroup),
  txt_nzsc_subgroup_name VARCHAR
  );

INSERT INTO nzsc_subgroups VALUES
...
CREATE TABLE IF NOT EXISTS nzsc_fam_profile_materials (
...
/* Table 24.1 */
INSERT INTO nzsc_fam_profile_materials VALUES
...
CREATE TABLE IF NOT EXISTS nzsc_fam_permeabilities (
...
/* Table 24.4 */  
INSERT INTO nzsc_fam_permeabilities VALUES 
  (1, 's', 'Slow', '< 4 mm/h'),
  (2, 'm', 'Moderate', '4 - 72 mm/h'),
  (3, 'r', 'Rapid', '> 72 mm/h');

CREATE TABLE IF NOT EXISTS nzsc_sib_depths (
...
/* Table 24.6 */  
INSERT INTO nzsc_sib_depths VALUES 
  (1, 'd', 'Deep', '> 100 cm'), 
  (2, 'md', 'Moderately deep', '≥ 45 - < 100 cm'),
  (3, 's', 'Shallow', '≥ 20 - < 45 cm'),
  (4, 'vs', 'Very Shallow' , '< 20 cm');

CREATE TABLE IF NOT EXISTS nzsc_sib_tsstone (
...
/* Table 24.7 */  
INSERT INTO nzsc_sib_tsstone VALUES 
 (1, '1', 'Stoneless', '< 1 %'),
...
CREATE TABLE IF NOT EXISTS nzsc_sib_texture (
...
/* Table 24.8 */  
INSERT INTO nzsc_sib_texture VALUES 
  (1, 'k', 'Skeletal'),
  (2, 'Tp', 'Peat or litter'),
  (3, 'Tc', 'Clayey peat'),
  (4, 'Tl', 'Loamy peat'),
...
CREATE TABLE IF NOT EXISTS nzsc_sib_drainage (
...
/* Table 24.9 */  
INSERT INTO nzsc_sib_drainage VALUES  
...
CREATE TABLE IF NOT EXISTS nzsc_sib_drainage_mods (
...
/* Table 24.10 */  
INSERT INTO nzsc_sib_drainage_mods VALUES   
...
CREATE TABLE IF NOT EXISTS nzsc_bp_rootbarriers (
...
/* Table 24.11-12 */  
INSERT INTO nzsc_bp_rootbarriers VALUES 
  (1,  'C',  'Chemical'),
...
CREATE TABLE IF NOT EXISTS nzsc (
  id_site VARCHAR REFERENCES sites(id_site) PRIMARY KEY,
  ...
  catu_nzsc_group VARCHAR,
  catu_nzsc_subgroup VARCHAR,
  FOREIGN KEY (catu_nzsc_order) REFERENCES nzsc_orders(catu_nzsc_order),
  FOREIGN KEY (catu_nzsc_order, catu_nzsc_group) REFERENCES nzsc_groups(catu_nzsc_order, catu_nzsc_group),
  FOREIGN KEY (catu_nzsc_order, catu_nzsc_group, catu_nzsc_subgroup)
     REFERENCES nzsc_subgroups(catu_nzsc_order, catu_nzsc_group, catu_nzsc_subgroup),
  
  /* family */
  catu_nzsc_fam_profile_material_1 VARCHAR REFERENCES nzsc_fam_profile_materials(catu_nzsc_fam_pm),
  catu_nzsc_fam_profile_material_2 VARCHAR REFERENCES nzsc_fam_profile_materials(catu_nzsc_fam_pm),
  
  catu_nzsc_fam_rock_1 VARCHAR REFERENCES nzsc_lithologies(catu_nzsc_lithology),
  catu_nzsc_fam_rock_2 VARCHAR REFERENCES nzsc_lithologies(catu_nzsc_lithology),
  ind_nzsc_fam_rock_mixed BOOLEAN,
  
  catu_nzsc_fam_rofines_1 VARCHAR REFERENCES nzsc_lithologies(catu_nzsc_lithology),
  catu_nzsc_fam_rofines_2 VARCHAR REFERENCES nzsc_lithologies(catu_nzsc_lithology),
  ind_nzsc_fam_rofines_mixed BOOLEAN,
  
  catu_nzsc_fam_texture VARCHAR REFERENCES simple_textures(cato_simple_texture),
  
  catu_nzsc_fam_perm_1 VARCHAR REFERENCES nzsc_fam_permeabilities(cato_nzsc_fam_perm),
  catu_nzsc_fam_perm_2 VARCHAR REFERENCES nzsc_fam_permeabilities(cato_nzsc_fam_perm),
  
  catu_nzsc_fam_pmo_1 VARCHAR REFERENCES nzsc_pmo(catu_pmo),
  catu_nzsc_fam_pmo_2 VARCHAR REFERENCES nzsc_pmo(catu_pmo),
  
  /* sibling */
  cato_nzsc_sib_depth VARCHAR REFERENCES nzsc_sib_depths(cato_nzsc_sib_depth),
  cato_nzsc_sib_tsstone VARCHAR REFERENCES nzsc_sib_tsstone(cato_nzsc_sib_tsstone),
  cato_nzsc_sib_texture_1 VARCHAR REFERENCES nzsc_sib_texture(cato_nzsc_sib_texture),
  cato_nzsc_sib_texture_2 VARCHAR REFERENCES nzsc_sib_texture(cato_nzsc_sib_texture),
  cato_nzsc_sib_drainage VARCHAR REFERENCES nzsc_sib_drainage(cato_nzsc_sib_drainage),
  
  /* not officially part of the sib definition 
     but doesn't make sense to store it elsewhere: */
  cato_nzsc_sib_drainage_mod VARCHAR REFERENCES nzsc_sib_drainage_mods(cato_nzsc_sib_drainage_mod),
  
  /* bps */
  catu_nzsc_bp_rootbarrier VARCHAR REFERENCES nzsc_bp_rootbarriers(catu_nzsc_bp_rootbarrier),

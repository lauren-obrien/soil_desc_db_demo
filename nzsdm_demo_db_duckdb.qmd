...
A naming convention is applied to the tables to clearly distingish data-storing tables ('dat\_\*') from controlled code lists ('cod\_\*') as duckDB doesn't support linking foreign keys across schemas.

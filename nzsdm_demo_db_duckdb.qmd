...
A naming convention is applied to the tables to clearly distingish data-storing tables ('dat_\*') from controlled code lists ('cod_\*') as duckDB doesn't support linking foreign keys across schemas.
...
# load the spatial extension into it
dbExecute(con2, "INSTALL spatial;")

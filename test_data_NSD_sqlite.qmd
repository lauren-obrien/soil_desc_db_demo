...
The data was coded with reference to the original scanned hardcopy descriptions, so some minor differences may exist between the website reports above and the improted data. Excel was used as an ersatz GUI rather than writing INSERT statements for time reasons.
...
# get a publicly available NZ-outlne polygon and trim to mainland area
ml <- 
